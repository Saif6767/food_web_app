            ...
            <div className='max-w-7xl mx-auto relative z-10'>
                        ...
                        <form onSubmit={handleSubmit} className='relative mt-4 group'>
                            ...
                            <div className="relative w-full max-w-md group">
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 rounded-full bg-amber-50/5 border-2 border-amber-400/30 focus:outline-none focus:border-amber-400 focus:ring-4 focus:ring-amber-400/20 transition-all duration-300 placeholder-amber-200/50 pr-32"
                                    required
                                />

                                {/* Button overlay on input */}
                                <button
                                    type="submit"
                                    className="absolute top-1/2 right-2 -translate-y-1/2 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all duration-500"
                                >
                ...
                <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
                    ...
                    <div className='group inline-block'>
                        <a href="https://www.linkedin.com/in/saif-ali-khan-27b163250/"
                            target='_blank'
