...
import { FiBook, FiHome, FiKey, FiLogOut, FiPackage, FiPhone, FiShoppingCart, FiStar } from 'react-icons/fi'
...
const Navbar = () => {
    ...
    const { totalItems, formatTotalItems } = useCart();
    const [showLoginModal, setShowLoginModal] = useState(false);

    // Combine Updating Login Modal And Auth Status On Location Changes
