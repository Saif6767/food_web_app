...
import { FiArrowRight, FiGlobe, FiMail, FiMapPin, FiMessageCircle, FiMessageSquare, FiPhone } from 'react-icons/fi'
...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        Dish: ${formDate.dish}
        Query: ${formDate.query}
        `;
        const encodedMessage = encodeURIComponent(message);

        const whatsappNumber = '917379806767';
    ...
    const handleChange = (e) => setFormData({ ...formDate, [e.target.name]: e.target.value });
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6 relative z-10'>
                            {contactFormFields.map(({ label, name, type, placeholder, pattern, Icon }) => (
                                <div key={name}>
                                    ...
                                    <div className='relative'>
                                        ...
                                        <input type={type} value={formDate[name]} name={name} onChange={handleChange}
                            ...
                            <div>
                                ...
                                <div className='relative'>
                                    ...
                                    <textarea rows="4" name="query" value={formDate.query} onChange={handleChange} 
                                     className='w-full pl-10 pr-4 py-3 bg-white/10 border-2 border-amber-500/30 rounded-xl text-amber-50 focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-amber-200/50'
