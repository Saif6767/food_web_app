...
export const socialIcons = [
    ...
    { icon: FaInstagram, link: 'https://www.instagram.com/_iamkhan_0.2/', color: '#E1306C', label: 'Instagram' },
...
// BUTTON BASE STYLES
export const addButtonBase = "relative flex items-center gap-2 bg-amber-600 px-4 py-2 rounded-full font-semibold text-white";
export const addButtonHover = "hover:bg-amber-700 active:scale-95";
